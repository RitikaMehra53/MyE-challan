...
public class PendingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView1 = (ListView)findViewById(R.id.listViewtrial);
        Intent i = getIntent();
    ...
    public void get_pending_challans(){
        ...
        if (rc.isEmpty() || rc.matches("[A-Za-z0-9]{10}")) {
            Toast.makeText(this, "Invalid RC",
        ...
        try{
            ...
            HttpPost hp=new HttpPost
                    ("http://studentportal.website/echallan/pending.php?rcNo="+rc);
            ...
            // Toast.makeText(getActivity(),"Hellotry",Toast.LENGTH_LONG).show();
            ...
            if(js.length()==0){
                ...
                PendingBaseAdapter pendingBaseAdapter=new PendingBaseAdapter(this,allData.details);
